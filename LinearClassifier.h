...
/*! \brief A Class for Linear Regression.
 *
 *  Output is a linear weighted combination of parameters.
...
class LinearClassifier
{
    public:
        ...
        */
        LinearClassifier(mat X, mat Y, double alpha, double thresh = 0.06, int num_iter = 300000);
